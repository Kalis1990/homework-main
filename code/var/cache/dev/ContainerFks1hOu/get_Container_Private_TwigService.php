...
class get_Container_Private_TwigService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtension(new \App\Twig\ReadingTimeExtension(($container->privates['App\\Service\\ReadingTimeCalculator'] ?? $container->load('getReadingTimeCalculatorService'))));
